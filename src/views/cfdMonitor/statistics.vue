...
export default {
  ...
  data() {
    return {
      ...
      requestUrl: "cfdStatistics",
      searchUrl: "cfdSearchStatistics",
      dynamicTable: [
        {
          name: "createTime",
          value: false,
        ...
        { name: "reverse", value: true, label: "正向成交量" },
        { name: "unReverse", value: true, label: "反向成交量" },
        { name: "realisedPNL", value: true, label: "指数盈亏" },
        { name: "originFee", value: true, label: "手续费(总)" },
        { name: "coin1fee", value: true, label: "TD手续费" },
        { name: "moneyRates", value: true, label: "利息" },
        { name: "burstMargin", value: true, label: "爆仓保费" },
        { name: "sinkDifference ", value: true, label: "小币种汇差" },
        { name: "realyPNL", value: true, label: "净盈亏" }
      ],
    ...
    setTableData(data) {
      ...
      data.forEach(function(element) {
        list.push({
          ...
          coin: element.Coin,
          unReverse: element.UnReverse,
          realisedPNL: element.RealisedPNL,
          profitLoss: element.ProfitLoss,
          originFee: element.OriginFee,
          coin1fee: element.Coin1fee,
          moneyRates: element.MoneyRates,
          burstMargin: element.BurstMargin,
