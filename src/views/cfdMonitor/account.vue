...
export default {
  ...
  data() {
    return {
      ...
      requestUrl: "cfdAccount",
      searchUrl: "cfdSearchAccount",
      dynamicTable: [
        {
          name: "createTime",
          value: false,
        ...
        { name: "volume", value: true, label: "当前资产" },
        { name: "change", value: true, label: "资产变化" },
        { name: "pay", value: true, label: "转入" },
        { name: "put", value: true, label: "转出" },
        { name: "profitLoss", value: true, label: "净盈亏" },
