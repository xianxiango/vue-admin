...
export default {
  ...
  data() {
    return {
      ...
      requestUrl: "futuresPosition",
      searchUrl: "futuresPositionSearch",
      dynamicTable: [
        ...
        { name: "markPrice", value: true, label: "标记价格" },
        ...
        { name: "state", value: false, label: "状态" },
    ...
    async setTableData(data) {
      ...
      data.forEach(function(element) {
        ...
        list.push({
          ...
          markPrice: this.numFilter(markPrice),
