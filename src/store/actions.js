...
export default {
  ...
  fetchAvailable({ commit, state }) {
    return new Promise((resolve, reject) => {
      ...
      // const available = ['admin', 'adminAccount', 'adminAccess', 'adminLogs', 'user', 'userList', 'userNexus', 'userOnline', 'userLogs', 'userDetail', 'futures', 'futuresPosition', 'futuresOrder', 'futuresHistory', 'stock', 'stockBuy', 'stockSell', 'counts', 'countsActive', 'countsUser', 'countsSilent', 'countsLoss', 'countsUsdt', 'order', 'orderPay', 'orderPut', 'orderAddress', 'orderTransfer', 'orderActivity', 'orderOther', 'notice']
